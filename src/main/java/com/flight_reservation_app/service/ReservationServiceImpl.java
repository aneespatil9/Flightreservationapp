...
import com.flight_reservation_app.uitilities.EmailUtil;
import com.flight_reservation_app.uitilities.PdfGenerator;
...
public class ReservationServiceImpl implements ReservationService {
	...
	public Reservation bookFlight(ReservationRequest request) {
		...
		reservation.setNumberOfBags(0);
		 ...
		 String filePath = "E:\\stsv4.17\\flight_reservation_app\\tickets\\reservation"+reservation.getId()+".pdf"; 
